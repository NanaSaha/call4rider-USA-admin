...
export class SetupPage implements OnInit {
  ...
  onSubmit(form: NgForm) {
    ...
    const description = "";
    const imageUrl = "";
    const phonedata = form.value.phone;
    let phone = "";
    if (phonedata !== undefined && phonedata !== null) {
      phone = phonedata.internationalNumber;
    }
    ...
    // {
    //   phone = countrycode.toString() + phone.slice(1);
    //   console.log(phone);
    // }
